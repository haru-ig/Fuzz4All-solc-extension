...
contract MutatedAddressStorage {
    ...
    mapping (uint => bytes) private boolArr;
    mapping(uint => mapping(uint => bytes)) private boolArr2;
    ...
    address public notOwnedAddress;


    constructor() {
        address1 = msg.sender;
        notOwnedAddress = msg.sender;
    }
