...
contract Mutate13 {
    ...
    function mutateFromFourth(uint256[2][2] memory array) public pure returns (uint256) { return array[1][1];}
    function main(uint256) private pure returns (uint256) { return 2; }
}
