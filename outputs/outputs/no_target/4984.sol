...
contract CCC { function f(uint256 a) public view {assert(a == a);} }
contract BC2 { function f(uint256 a) public view {a += 2;} }
contract A2 { function f(uint256 a) public view returns(uint256){ return a; } }
contract BC22 { function f(uint256 a) public view {a += 2;} }
<fim_middle>contract CCC { function f(uint256 a) public view {assert(a >= 0);} }
