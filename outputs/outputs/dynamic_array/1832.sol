...
contract SemanticallyEquivalentFixedDynamicNonFixedSizeArrayAssignment {
    struct ItemStruct {
        uint256 member1;
        uint256 member2;
    }
...
contract SemanticallyEquivalentNonFixedDynamicNonFixedSizeArrayAssignment {
    struct ItemStruct {
        uint256 member1;
        uint256 member2;
    }
...
contract SemanticallyEquivalentFixedDynamicNonFixedSizeVector {
    struct ItemStruct {
        uint
